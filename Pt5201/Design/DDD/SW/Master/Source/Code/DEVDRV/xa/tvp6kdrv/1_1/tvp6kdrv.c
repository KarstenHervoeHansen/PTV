...
int tvp6k_system( int system)
{
	...
	if ( system < NTSC)
	{
		...
		buffer[0] = 0x5A;
		buffer[1] = 0x00;
		buffer[2] = 0x30;		//was 0x10, 0x32
		buffer[3] = 0x96;		//was 0x80, 0xAC
		buffer[4] = 0xB3;
		buffer[5] = 0xBE;
		buffer[6] = 0x3F;
		buffer[7] = 0x20;
		buffer[8] = 0x42;
		buffer[9] = 0x3E;		// was 0x41
		buffer[10] = 0xCB;
		buffer[11] = 0x8A;
		buffer[12] = 0x09;
		buffer[13] = 0x2A;
	...
	else
	{
		...
		buffer[0] = 0x5A;
		buffer[1] = 0x00;
		buffer[2] = 0x12;		// was 0x01, 0x03
		buffer[3] = 0x85;		// was 0x6B, 0x6E
		buffer[4] = 0xC1;
		buffer[5] = 0xB8;
		buffer[6] = 0x30;		// was 0x2E
		buffer[7] = 0x20;
		buffer[8] = 0x41;
		buffer[9] = 0x3C;		// was 0x38
		buffer[10] = 0x1F;
		buffer[11] = 0x7C;
		buffer[12] = 0xF0;
		buffer[13] = 0x21;
