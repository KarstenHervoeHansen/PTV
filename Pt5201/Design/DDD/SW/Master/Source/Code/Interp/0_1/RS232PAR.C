...
#define Udr_InChar(void) rs232getchar(void)
// void Udr_PutChar( char ch);
#define Udr_PutChar(ch) rs232putchar(ch)
// void Udr_PutNChar( char *s);
#define Udr_PutNChar(str) rs232puts(str)
// void Udr_CPutNChar( code char *s);
#define Udr_CPutNChar(str) while(str++) rs232putchar(*str)
// void Udr_PutNewline( void);
#define Udr_PutNewline() rs232putchar('\r')
