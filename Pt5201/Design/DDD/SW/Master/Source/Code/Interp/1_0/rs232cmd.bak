...
void FactCBGenDate( void);
void FactCBGenAGain( void);
void FactCBGenCGain( void);
void FactCBGenPhase( void);
void FactCBGenScHPhase( void);
...
struct CMD_STRUCT code CBGenLevel1[5] = {
	...
	{ EMBAUDIOCmdTxt, EMBCmdTxt, 	NULL, 			  &CBGenLevel1_1[0], NONE, CBGenEmbAudioSignal},
};

struct CMD_STRUCT code CBGenLevel1_1[2] = {
...
struct CMD_STRUCT code Factory[12] = {
	...
	{ CBGENERATORCmdTxt, CBGCmdTxt, 	&Factory[8],  &FactoryLevel5[0], NONE,		  	 FactCBGenDate},
...
struct CMD_STRUCT code FactoryLevel5[5] = {
	{ DATECmdTxt,  	DATECmdTxt, &FactoryLevel5[1], NULL, NONE, FactCBGenDate},
	{ AGAINCmdTxt, 	AGACmdTxt, 	&FactoryLevel5[2], NULL, NONE, FactCBGenAGain},
	{ CGAINCmdTxt, 	CGACmdTxt, 	&FactoryLevel5[3], NULL, NONE, FactCBGenCGain},
	{ PHASECmdTxt, 	PHASCmdTxt, &FactoryLevel5[4], NULL, NONE, FactCBGenPhase},
	{ SCHPHASECmdTxt,	SCHPCmdTxt, NULL, 				 NULL, NONE, FactCBGenScHPhase},
};
