...
{	
	...
	if ( Calibration.ResetSystem < NTSC)
	...
	Settings.AudioSetup[AESEBUAudio].Level = AudioSetup[AESEBUAudio].Level = 0;
	...
	Settings.AudioSetup[AnalogAudio].Level = AudioSetup[AnalogAudio].Level = 0; 
...
{	
	...
	return( SetAudioOutput( Settings.AudioOutput));
}
