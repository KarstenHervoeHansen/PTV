...
/* #define BAUDRATE     (unsigned long)2400     /* select  2400 baud */
/* #define BAUDRATE     (unsigned long)4800     /* select  4800 baud */
 #define BAUDRATE     (unsigned long)9600     /* select  9600 baud */
/* #define BAUDRATE    (unsigned long)19200     /* select 19200 baud */
...
#define RX1INTLVL 0x0A   /* defines priority level for receive  1 */
#define TX1INTLVL 0x09   /* defines priority level for transmit 1 */

unsigned int b=RELOAD1;
/* =================== */
/* S1CON - bit settings */
/* ------------------- */
/* TIMER 0             */
...
#define U1_TI_0  (1 << 1)   /* set the transmit interrupt flag */
#define U1_RI_0  (1 << 0)   /* set the receive interrupt flag */ 
...
#define T1_IE1  (1 << 3)   /* interrupt edge flag - enabled */
...
//   EA = 0;
   ...
   ET1 = 0;    /* Timer 1 enable bit  - enabled */
...
//   _S1STAT.Byte=0x00;
   ...
   TCON &= 0x33;   /* clear timer1 settings */
   TCON |= xTCON;
