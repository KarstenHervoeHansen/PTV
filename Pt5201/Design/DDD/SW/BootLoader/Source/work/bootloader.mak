...
PROJ    = bootloader
PROJDIR = d:\project\pt5201\bootloader\source\work
PRODDIR = C:\cxa
...
flash.src   : flash.c system.h c:\cxa\include\string.h flash.h
  ...
  $(EMPTY)  -IC:\cxa\include -Ml -Cxag3 -Sd -A1 -O1 -DWritableSector=14 -DBootProgram=0 -g
  EOF
...
loader.src  : loader.c system.h loader.h flash.h
...
test.src    : test.c system.h main.h test.h iic.h xaexprt.h xadrivr.h
	C:\cxa\bin\cxa.exe test.c -f<<EOF
  $(EMPTY)  -IC:\cxa\include -Ml -Cxag3 -Sd -A1 -O1 -DWritableSector=14 -DBootProgram=0 -g
  EOF

test.obj    : test.src
	C:\cxa\bin\asxa.exe test.src -f<<EOF
  $(EMPTY)  NOZP -gs -LcDElMnPQsWXy -OHjs -DMODEL_LARGE CA -Cxag3
  EOF

$(PROJ).out : flash.obj iic.obj loader.obj main.obj rs232cmd.obj rs232err.obj rs232par.obj util.obj xadrivr.obj xaintfc.obj test.obj bootloader.i
