...
extern void SaveCommPort( char *port);
extern void RestoreCommPort( char **port);
...
extern void StatusTrackBarUpdate( int System, long Samples, TTrackBar *TrackBar);
...
extern int TrxGenlockCalibEnable( bool enable);
extern int TrxGenlockCalibAdjust( int adjust);
extern int TrxGenlockCalibStore( void);
