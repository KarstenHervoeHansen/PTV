...
void __fastcall TPT5201Form::FormCreate(TObject *Sender)
{
  ...
  RestoreWindowPosition( PT5201Form, "");
	...
	StringGrid1->Cells[0][2] = "Timing";
	StringGrid1->Cells[0][3] = "ScH-Phase";
	StringGrid1->Cells[0][4] = "Pattern";

	StringGrid1->Cells[1][0] = "Genlock";
	StringGrid1->Cells[2][0] = "Black Burst #1";
	StringGrid1->Cells[3][0] = "Black Burst #2";
	StringGrid1->Cells[4][0] = "Black Burst #3";
	StringGrid1->Cells[5][0] = "Color Bar";
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TPT5201Form::StringGrid1DblClick(TObject *Sender)
{
	;
}
//---------------------------------------------------------------------------
