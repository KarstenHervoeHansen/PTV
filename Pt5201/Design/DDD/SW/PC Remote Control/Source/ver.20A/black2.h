...
//---------------------------------------------------------------------------
class TBlack2Form : public TForm
{
__published:	// IDE-managed Components
 ...
 void __fastcall ScHPhaseUpDownChanging(TObject *Sender, bool &AllowChange);
private:	// User declarations
	TBlackGenerator *BlackSetup, *BlackCancel;
	int ModelessResult;
public:		// User declarations
	__fastcall TBlack2Form(TComponent* Owner);
	void __fastcall LockForm( bool Lock);
	void __fastcall UpdateOutput( TBlackGenerator *setup);
};
//---------------------------------------------------------------------------
extern TBlack2Form *Black2Form;
//---------------------------------------------------------------------------
#endif
