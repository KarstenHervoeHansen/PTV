...
enum GeneratorType			{ GenlockType = 0, BlackType, TSGType, AudioType };
enum GenlockSystem			{ InternalGenlock=0, PALGenlock, NTSCGenlock, f10MHzGenlock};
enum BBSystemType				{ PAL = 0, PAL_ID, NTSC};
enum TSGSystemType			{ TSG_PAL = 0, TSG_NTSC};
...
enum AnalogLevelType			{ P10dBm = 0, P8dBm, P7dBm, P6dBm, P5dBm,\
									  ...
									  M8dBm, M9dBm, M10dBm, M11dBm, M12dBm, M13dBm,\
									  M15dBm, M18dBm, M21dBm, M24dBm, M27dBm, M30dBm,\
									  M33dBm, M36dBm, AnalogSilence};

enum TSGPatterns				{ SMPTECBar = 0, EBUCBar,	FCCCBar, EBUCBarITU, CBar100,\
...
extern const char* BBSystemTxt[];
extern const char* TSGSystemTxt[];
...
extern const char* TSGSystemCmdTxt[];
