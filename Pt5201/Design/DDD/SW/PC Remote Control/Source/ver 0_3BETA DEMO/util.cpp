...
//---------------------------------------------------------------------------
int SendAudioSignal( int output, int signal)
{
	if ( !PT5201CommPort->Connected())
  	return( -1);
...
//---------------------------------------------------------------------------
int SendAudioLevel( int output, int level)
{
	if ( !PT5201CommPort->Connected())
  	return( -1);
...
//---------------------------------------------------------------------------
int SendAudioClick( int output, int click)
{
	if ( !PT5201CommPort->Connected())
  	return( -1);
