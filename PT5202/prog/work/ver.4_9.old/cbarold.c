...
//
//
//int Update_StatusPort( UI temp_status)
//{
//   temp_status = Status;
//   temp_status &= 0xFF; 	// Forsing the compiler to write from a register instead from a
//				// internal memory lacation.
//   PLD_StatusPort = temp_status; // Update status port
//   return( OK);
//}
