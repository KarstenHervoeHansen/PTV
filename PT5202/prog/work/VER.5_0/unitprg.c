...
/* TASKS:                                                                   */
/*                                                                          */
/* NOTES: BBSPGCommunication() changed to implement it under new serial     */
/*        drivers with no RTOS and serial receive interrupt driven only     */
/*                                                                          */
/****************************************************************************/
/*
...
/* Remarks:	 																															*/
/* Returns:																																*/
/* Updates: 06.05.03: Changed to run with new serial drivers							*/
/**************************************************************************/
void BBSPGCommunication( int unit)
{
	...
	ETI0 = 0;										// Disable SIO0 Tx-interrupt

	ERI1 = 1;										// Enable SIO1 Rx-interrupt
	ETI1 = 0;										// Disable SIO1 Tx-interrupt
