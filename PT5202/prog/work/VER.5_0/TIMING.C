...
/*  Updates:                                            */
/***************************************************************************/
void AnalogSamplesToFLT( UC system, long samples, char* sign, int* F, int* L, float* T)
  {
  long l =samples;
  char frame, field;
  int  line;
...
void SDISamplesToFLT( UC system, long samples,\
  ...
  *sign = '+';
  ...
  if (system < NTSC_US) {            // If system selected is SDI625..
