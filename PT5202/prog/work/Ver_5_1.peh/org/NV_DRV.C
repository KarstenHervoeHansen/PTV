...
#define NV_size ((NvPointer)8*1024-16)
...
/* NV_Init																										   NV_DRV.C	*/
/*																																				*/
/* Author:		Sten A.Andersen, DEV, xxxxxx																*/
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Initialise NV RAM hardware															 		*/
/* Remarks:																																*/
/* Returns:																																*/
/* Updates:																																*/
/**************************************************************************/
...
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Allocate preset memories using allocP												*/
/* Remarks:																																*/
/* Returns:		NvPointer to allocated preset if ram available, otherwise 	*/
/*						NvNull																											*/
/* Updates:																																*/
/**************************************************************************/
...
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Allocate memory for storing data with double & checksum			*/
/* Remarks:																																*/
/* Returns:		NvPointer to allocated preset if ram available, otherwise 	*/
/*						NvNull																											*/
/* Updates:																																*/
...
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Store item in NV memory																			*/
/* Remarks:																																*/
/* Returns:		OK only																											*/
/* Updates:																																*/
/**************************************************************************/
...
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Read item from NV memory																		*/
/* Remarks:		If 1st item fails and the 2nd item is allright, the 2nd 		*/
/*						item will be copied to the 1st item													*/
/* Returns:		FAIL if both 1st & 2nd copy	checksum test fails otherwise		*/
/*						OK																													*/
/* Updates:																																*/
/**************************************************************************/
...
{
	int i;
	CheckType testsum, checksum = CheckBase;
	UC *dst_point ;
...
/*																																				*/
/* Author:		Sten A.Andersen, DEV, xxxxxx																*/
/* Revised:		000413, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Store presets, (single storage items with checksum)					*/
/* Remarks:																																*/
/* Returns:		OK only																											*/
/* Updates:																																*/
/**************************************************************************/
...
/* Revised:		000411, KEn, DEV     																				*/
/*																																				*/
/* Function: 	Recall presets, (single storage items with checksum)		 		*/
/* Remarks:																																*/
/* Returns:		FAIL if checksum error, otherwise OK												*/
/* Updates:																																*/
/**************************************************************************/
