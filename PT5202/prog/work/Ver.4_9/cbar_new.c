...
#define SRAMBank5      0x20	//Rest of the Banks are not used !
...
//Emulates the aight lines avalible for text.
...
void CBLineInterrupt( void)
  ...
  static UC LineNum;  //Used to prevent Interlaving flicker ! 
