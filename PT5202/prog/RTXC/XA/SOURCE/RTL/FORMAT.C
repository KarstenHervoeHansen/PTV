...
*/
/*==========================================================================*/
/* NOTE: This is for internal use in RTXCbug only                           */
/*==========================================================================*/
...
#define xFLOAT   /* indicates Fx.x/Dx.x supported, suppress on most */
...
int formatv(char *fmt, char *buffer, va_list arg_ptr)
{
   ...
   char *tb_ptr, *str_ptr, delim, temp;
...
#ifdef FLOAT
   long l_sig, m_sig;
   char DOUBLE; /* Dw.d vs Fw.d mode */
   struct flot /* floating point structure */
   {
      char width;     /* field length */
      char dec_pt;    /* no. of positions after dec pt */
   } flt;
#ifndef FLOATLESS
   float float_val;
   double double_val;
