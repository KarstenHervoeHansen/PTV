 ...
 * TEST     
 *            
 * MODIFIED:     20.03.2003: DELTA version for 5201/5202 JK
 *
...
#define TESTSWVER  "VER. DELTA: 5202"
#define CHECKED    1
#define UNCHECKED  0
...
if (argc > 1)
  ...
  SetCtrlVal (mainPNL, MAIN_PNL_NAME1, "PT5201/02");
...
void set_standard(int which)
  ...
  switch (which)
    ...
    case NTSCJP:
      Delay(0.3);
      WriteCOMPort(DUTCOM,":FACT:MAIN:SYST JNTSC;"); // This makes reset_instrument, very long 
      break;
    }
  ...
  Delay(1.0);
  SetCtrlVal(fPNL, F_PNL_TEXTBOX," *");
  WriteCOMPort(DUTCOM,":FACT:MAIN:IDN:TYPE 'PT5202';"); 
  Delay(0.3);
  SetCtrlVal(fPNL, F_PNL_TEXTBOX," *");
