...
/*                                                                          */
/*  Changes:                                                                */
/* 10.01.2005: Window10, Window15, Window20 changed to full screen          */
/*             i.e. no windows, for MEDIAPLAZA in Germany.                  */
/*             Added MEDIAPLAZA def in d1pattg.h                            */
/*                                                                          */
...
#ifdef MEDIAPLAZA
code struct PATTERN_ITEM G_Window15[6] =
  {
  SyncLineB,        -22,   0, &G_Window15[1],
  Window15,        -288,   0, &G_Window15[2],
  SyncLineB,         -2,   0, &G_Window15[3],

  SyncLineA,        -23,   0, &G_Window15[4],
  Window15+1,      -288,   0, &G_Window15[5],
...
#ifdef MEDIAPLAZA
code struct PATTERN_ITEM G_Window20[6] =
  {
  SyncLineB,        -22,   0, &G_Window20[1],
  Window20,        -288,   0, &G_Window20[2],
  SyncLineB,         -2,   0, &G_Window20[3],

  SyncLineA,        -23,   0, &G_Window20[4],
  Window20+1,      -288,   0, &G_Window20[5],
...
typedef struct PATTERN_ITEM
  ...
  code UI LineType;
  code UI NextIntrIn;
  code UI LineAddrStart;

  code struct PATTERN_ITEM* NextPattern;
  };
...
#ifdef MEDIAPLAZA
code struct PATTERN_ITEM G_Window10[6] =
  {
  SyncLineB,        -22,   0, &G_Window10[1],
  Window10,        -288,   0, &G_Window10[2],
  SyncLineB,         -2,   0, &G_Window10[3],

  SyncLineA,        -23,   0, &G_Window10[4],
  Window10+1,      -288,   0, &G_Window10[5],
