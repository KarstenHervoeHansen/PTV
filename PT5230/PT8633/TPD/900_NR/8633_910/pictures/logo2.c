...
#define BMP_FILE "net1.bmp"     /* File containing logo */
...
#define BLOCK   IMSTART + 103   /* Start adderss in PROM where our logo is to be */
#define NR_LINES          25   /* Number of logo lines in our picture */
#define LOGO_START  (int)315   /* X coordinare of upper left logo sample in our picture */
