...
code struct PATTERN_ITEM G_Red75[6] = {
	...
	code struct PATTERN_ITEM G_Philips4x3[36] = {
		...
		CounterType,			-50,	6, &G_Philips4x3[8],		// 6: Normal+434
		...
		CounterType,			-21,	26, &G_Philips4x3[16],	// 12: Motion+1
		...
		CounterType,			-21,	27, &G_Philips4x3[25],	// 18: Motion+2
		...
		CounterType,			-21,	28, &G_Philips4x3[34],	// 23: Motion+3
...
#if PT8633Version
	code struct PATTERN_ITEM G_Philips16x9[52] = {
		...
		CounterType,			-56,	6, &G_Philips16x9[11],		//	6: Cirkel
		CounterType,			-15,	3976, &G_Philips16x9[12],	// Normal
		SyncLineB,				-2,	0, &G_Philips16x9[13],

		SyncLineA,				-23,	0, &G_Philips16x9[14],
		CounterType,			-14,	3431, &G_Philips16x9[15],	// Normal
		CounterType,			-72,	7, &G_Philips16x9[16],		//	7: Cirkel+1
		CounterType,			-15,	3603, &G_Philips16x9[17],	// Normal
		CounterType,			-32,	8, &G_Philips16x9[18],		// 8: AntiPAL+1
		CounterType,			-1,	3697, &G_Philips16x9[19],	// Normal
		CounterType,			-20,	9, &G_Philips16x9[20],		// 9: Date/Time+1
		CounterType,			-21,	10, &G_Philips16x9[21],		// 10: PLUGE+1
		CounterType,			-21,	3781, &G_Philips16x9[22],	// Normal
		CounterType,			-21,	11, &G_Philips16x9[23],		//	11: Greyscale+1
		CounterType,			-56,	12, &G_Philips16x9[24],		//	12: Cirkel+1
		CounterType,			-15,	3977, &G_Philips16x9[25],	// Normal
		SyncLineA,				-2,	0, &G_Philips16x9[26],

		SyncLineB,				-22,	0, &G_Philips16x9[27],
		CounterType,			-14,	3430, &G_Philips16x9[28],	// Normal
		CounterType,			-72,	1, &G_Philips16x9[29],		//	1: Cirkel
		CounterType,			-15,	3602, &G_Philips16x9[30],	// Normal
		CounterType,			-32,	13, &G_Philips16x9[31],		// 13: AntiPAL+2
		CounterType,			-1,	3696, &G_Philips16x9[32],	// Normal
		CounterType,			-20,	3, &G_Philips16x9[33],		// 3: Date/Time
		CounterType,			-21,	4, &G_Philips16x9[34],		// 4: PLUGE
		CounterType,			-21,	3780, &G_Philips16x9[35],	// Normal
		CounterType,			-21,	5, &G_Philips16x9[36],		//	5: Greyscale
		CounterType,			-56,	6, &G_Philips16x9[37],		//	6: Cirkel
		CounterType,			-15,	3976, &G_Philips16x9[38],	// Normal
		SyncLineB,				-2,	0, &G_Philips16x9[39],

		SyncLineA,				-23,	0, &G_Philips16x9[40],
		CounterType,			-14,	3431, &G_Philips16x9[41],	// Normal
		CounterType,			-72,	7, &G_Philips16x9[42],		//	7: Cirkel+1
		CounterType,			-15,	3603, &G_Philips16x9[43],	// Normal
		CounterType,			-32,	14, &G_Philips16x9[44],		// 14: AntiPAL+3
		CounterType,			-1,	3697, &G_Philips16x9[45],	// Normal
		CounterType,			-20,	9, &G_Philips16x9[46],		// 9: Date/Time+1
		CounterType,			-21,	10, &G_Philips16x9[47],		// 10: PLUGE+1
		CounterType,			-21,	3781, &G_Philips16x9[48],	// Normal
		CounterType,			-21,	11, &G_Philips16x9[49],		//	11: Greyscale+1
		CounterType,			-56,	12, &G_Philips16x9[50],		//	12: Cirkel+1
		CounterType,			-15,	3977, &G_Philips16x9[51],	// Normal
...
#if PT8633Version
	code struct PATTERN_ITEM G_FuBK16x9[28] = {
		SyncLineB,				-22,	0, &G_FuBK16x9[1],
		CounterType,			-203,	2694, &G_FuBK16x9[2],
		CounterType,			-40,	1, &G_FuBK16x9[3],			// 1: AntiPAL+1
		CounterType,			-1,	3180, &G_FuBK16x9[4],		// Normal
		CounterType,			-19,	5, &G_FuBK16x9[5],			// 5: Date/Time
		CounterType,			-25,	3220, &G_FuBK16x9[6],		// Normal
		SyncLineB,				-2,	0, &G_FuBK16x9[7],

		SyncLineA,				-23,	0, &G_FuBK16x9[8],
		CounterType,			-203,	2695, &G_FuBK16x9[9],
		CounterType,			-40,	2, &G_FuBK16x9[10],			// 2: AntiPAL+2
		CounterType,			-1,	3181, &G_FuBK16x9[11],		// Normal
		CounterType,			-19,	6, &G_FuBK16x9[12],			// 6: Date/Time+1
		CounterType,			-25,	3221, &G_FuBK16x9[13],		// Normal
		SyncLineA,				-2,	0, &G_FuBK16x9[14],

		SyncLineB,				-22,	0, &G_FuBK16x9[15],
		CounterType,			-203,	2694, &G_FuBK16x9[16],
		CounterType,			-40,	3, &G_FuBK16x9[17],			// 3: AntiPAL+3
		CounterType,			-1,	3180, &G_FuBK16x9[18],		// Normal
		CounterType,			-19,	5, &G_FuBK16x9[19],			// 5: Date/Time
		CounterType,			-25,	3220, &G_FuBK16x9[20],		// Normal
		SyncLineB,				-2,	0, &G_FuBK16x9[21],

		SyncLineA,				-23,	0, &G_FuBK16x9[22],
		CounterType,			-203,	2695, &G_FuBK16x9[23],
		CounterType,			-40,	4, &G_FuBK16x9[24],			// 4: AntiPAL+4
		CounterType,			-1,	3181, &G_FuBK16x9[25],		// Normal
		CounterType,			-19,	6, &G_FuBK16x9[26],			// 6: Date/Time+1
		CounterType,			-25,	3221, &G_FuBK16x9[27],		// Normal
