 ...
 * NOTES:           The logo is inserted in lower part of Philips NTSC picture
 *                  Logo file is mid.bmp
 *                  Logo starts at 5167   (Start address in PROM)
 */
...
#define BMP_FILE "mid.bmp"

#define BLOCK           5167

#define BMP_LINE_LEN    (long)(246 * 3 + 2)   /* 872 orgLine len in .BMP-fil. 246 samples of 3 bytes */
#define NR_BMP_LINES     57    /* Number of lines in our .bmp file */
#define NR_LINES         36    /* Number of logo lines in our picture */
#define CHAN_LINE_LEN  1024L   /*Line len in channelx.dat-files (word) */

#define LOGO_LEN        (int)((BMP_LINE_LEN - 2) / 3)
#define LOGO_START      253

#define LOGO_LINES_TO_SKIP  9  /* 7 skip first LOGO_LINES_TO_SKIP when loading logo */
...
/*    insert_logo(288, 475, -280);*/
    for (j = LOGO_START; j < LOGO_START + LOGO_LEN - 3; j++)
      {
