...
/*		void AES_EBUnItemLeft();															*/
/*		void AES_EBUnItemRight();															*/
/*		void ItemLeft();																		*/
/*		void ItemRight();																		*/
...
void StatusItemLeft() {
	...
	do {
		...
		switch ( Ptr->ItemNumber) {
			...
			case StatusAudio1Item:
				if ( !AES_EBUUnit.Present)
					Found = FALSE;
				break;

			case StatusAudio2Item:
				if ( !AES_EBUUnit.Present || ( Connectors[AESConn].HWType != PT8635))
					Found = FALSE;
				break;
		}
	} while ( !Found);
...
/***************************************************************************/
/*	AES_EBUnItemLeft															 	  MENUHLP.C	*/
/*																									*/
/* Author:		Kim Engedahl, DEV, 991007	    										*/
/* Revised:		991007				     													*/
/*																									*/
/*	Function:	Select previous item in the AES-EBU MENU							*/
/*	Remarks:		--																				*/
/*	Returns:		--																				*/
/*	Updates:		Ptr																			*/
/***************************************************************************/
void AES_EBUnItemLeft() {
	...
	if ( Ptr->ItemNumber == AES_EBU2Item)
		if ( Connectors[AESConn].HWType != PT8635)
			Ptr = Ptr->PrevItem;
}

/***************************************************************************/
/*	AES_EBUnItemRight														 	  MENUHLP.C	*/
/*																									*/
/* Author:		Kim Engedahl, DEV, 991007	    										*/
/* Revised:		991007				     													*/
/*																									*/
/*	Function:	Select next item in the AES-EBU MENU								*/
/*	Remarks:		--																				*/
/*	Returns:		--																				*/
/*	Updates:		Ptr																			*/
/***************************************************************************/
