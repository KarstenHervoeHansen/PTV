...
code struct MENU_ITEM status_menu[StatusMax] = {
	...
	{	StatusAudio1Item, NULL, 0, ( L_+D_+R_),
		StatusAudioUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[5], &status_menu[3],
	},
	{	StatusAudio2Item, NULL, 0, ( L_+D_+R_),
		StatusAudioUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
...
code struct MENU_ITEM base_menu[BaseMax] = {
	...
	{	AES_EBUItem, AES_EBUTxt, 0, ( L_+D_+U_+R_+MORE_),
		BaseMenuShow,
		BaseItemLeft, UpToStatus, BaseDown, BaseItemRight, NONE, NONE,
...
code struct MENU_ITEM AES_EBUn_menu[NoOfAES_EBUUnits] = {
	{	AES_EBU1Item, AES_EBU1Txt, 8, ( L_+D_+U_+R_),
		AES_EBUnMenuShow,
		AES_EBUnItemLeft, UpToBase, AES_EBUnDown, AES_EBUnItemRight, NONE, NONE,
		&AES_EBUn_menu[1], &AES_EBUn_menu[1]
	},
	{	AES_EBU2Item, AES_EBU2Txt, 18, ( L_+D_+U_+R_),
		AES_EBUnMenuShow,
		AES_EBUnItemLeft, UpToBase, AES_EBUnDown, AES_EBUnItemRight, NONE, NONE,
		&AES_EBUn_menu[0], &AES_EBUn_menu[0]
	},
};
...
code struct MENU_ITEM AES_EBU_menu[AES_EBUMax] = {
	{	AES_EBUSignalItem, SignalTxt, 8, ( L_+D_+U_+R_),
		AES_EBUMenuShow,
		ItemLeft, UpToAES_EBUn, AES_EBUDown, ItemRight, NONE, NONE,
