...
code struct MENU_ITEM status_menu[StatusMax] = {
	{	StatusPresetItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusPresetUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[1], &status_menu[5],
	},
	{	StatusGenlockItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusGenlockUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[2], &status_menu[0],
	},
	{	StatusAnalogSignalItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusAnalogSignalUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[3], &status_menu[1],
	},
	{	StatusSDISignalItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusSDISignalUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[4], &status_menu[2],
	},
	{	StatusAudioItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusAudioUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
		&status_menu[5], &status_menu[3],
	},
	{	StatusErrorItem, NULL, 0, ( L_+D_+R_+MORE_),
		StatusErrorUpdate,
		StatusItemLeft, NONE, StatusDown, StatusItemRight, NONE, NONE,
