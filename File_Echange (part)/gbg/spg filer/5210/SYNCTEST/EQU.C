...
#define phmar	   0x000001e7 // graense for at godkende h fase
#define samp	   4	// value for setting sampling (use in LINEINT)
#define sch61	   0xf3 // ? sv. til 0 degr. hysterese - 0??h til 11 degr.)
...
#define buamg1_m   95	// burst detection
#define buamg2_m   133	// burst detection
#define bupos_m	   91	// relativ burst position i forhold til sync
...
//  D1/525-VERSION
#define afield_d5  1	//
#define bmax_d5	   209	// limit for b counter (5-line groups)
#define bpreset_d5 208	//  vaerdi til brug ved field1 interrupt
...
#define fmax_d5	   4	// limit for f counter (frames)
...
#define hlen_d5	   864	// line length in clockpulses
...
#define refmult_d5 0x4000 // subc.ref frame offset
#define subcinc_d5 0xbec5 // fasetilvaekst paa subc. paa x lin.
#define syg2_d5	   36	// graense for sync amplitude upper
#define typesize_d5 112	// size of tabel for types
#define vlenmin_d5 623	// no. of lines to frame check window
