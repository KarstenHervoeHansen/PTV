...
code struct AES_EBU_STRUCTURE AES_EBUConfigFactory = {
	AES_EBUStereo800Hz,			// AES-EBU signal
	AES_EBUSilence,				// AES-EBU level
	AES_EBUPAL						// AES-EBU Timing
};
...
void FactoryPreset() {
	...
	Preset[1].AES_EBUStore.Timing = AES_EBUNTSCPhase1;
