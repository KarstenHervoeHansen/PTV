...
// Skriver b†de kaldene og symbolerne for dem ud
...
//    udskrives b†de kald og symboler.
...
//      symbols_on= 0;
   ...
   {  while (readln(opgave,kald[1]))
      {  n= 1;
	 printf("%s ",kald[1]);	// skriv 1' soegeord
