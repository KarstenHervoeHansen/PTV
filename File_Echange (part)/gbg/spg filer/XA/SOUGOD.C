...
xdata UC trtext[]= "\240       ";	/* store for transmit-text */
xdata UC trtext7[]= "\240       ";	/* store for do. VPS, Word 7 */
code UC trtext2[]= "\240       ";	/* VPS-text for opposite field */
...
/* ********************************************************************	*/
void copys(UC far s[], UC far t[], UC n)
