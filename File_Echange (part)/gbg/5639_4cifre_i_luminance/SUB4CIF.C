...
/* last chg:	911030	*/	/* look for : ***	   */
/* prev. chg:	911029	*/
/* org.date:	901224	*/
/* name:	P.Chr.	*/

/* 911030 Watch-dog reset only shuts down at wanted "OFF"		*/
...
void findorg(void)	/* find top line phosphor no. for phosphor list display */
{
 ...
 /*  if (phos_org > 1) outtextxy(1,3,"Scroll");	 special version 
  if (phos_org < phosmax - menu[3].maxline + 4)
    outtextxy(1,menu[3].maxline+2,"Scroll");
 */
}
