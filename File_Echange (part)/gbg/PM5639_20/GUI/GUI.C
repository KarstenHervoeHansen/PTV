...
/*																									*/
/*	Changes:																						*/
/* 990920:	Changed Philips.. to ProTeleVi..											*/
/* 970826:	Added new text for PM5639/25 Miniature CRT sensor					*/
/* 970820:	Added const char* BaudText[]												*/
/***************************************************************************/
...
int initGraphics( void) {
	...
	if ( !strcmp( SoftwareType, "INDU"))
		StartUpScreen( "PM 5639 Industrial CRT Color Analyzer",
						"ProTeleVision Technologies A/S, Denmark", "1999");
	else {
		if ( !strcmp( SoftwareType, "SMLL"))
			StartUpScreen( "PM 5639 Miniature CRT Color Analyzer",
							"ProTeleVision Technologies A/S, Denmark", "1999");
		else
