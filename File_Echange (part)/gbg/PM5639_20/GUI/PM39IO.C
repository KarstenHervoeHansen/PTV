...
/*	Org. date:	------																		*/
/*	Rev. date:	970820, KEn	DEV															*/
/*	Status:		Version -.-																	*/
/*																									*/
/*	This module contains the following functions:									*/
/*																									*/
/*	Changes:																						*/
/* 970820:	Added variable Baud9600 to select 4800 to enable both 4800-		*/
/*				and 9600-baudarates, ( function: Open_COM())							*/
/***************************************************************************/
...
char Baud9600 = 0;						/* Default 0 equ. 4800 baud */
		...
		case COM3:
			if ( _COM1_Interrupt != getvect( _COM1_intr)) {
				...
				if ( PortBase == 0x3220) {			/* If PC is a PS/2 */
					...
					reg.r_cx = 0x0306+Baud9600;	/* 0x306: 8 data, 4800 baud */
															/* 0x307: 8 data, 49600 baud */
					reg.r_dx = COM_Port;				/* Serial port COM1(3) */
				}
				else {
					reg.r_ax = 0xC7+32*Baud9600;	/* 0xC7: 4800 baud, 8D, 2S, NP */
															/* 0xE7: 4800 baud, 8D, 2S, NP */
