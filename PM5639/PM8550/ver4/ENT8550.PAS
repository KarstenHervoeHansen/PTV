...
*)
CONST QQQStartPos = $29000;
      WWWStartPos = $9000;
      KUPixelFileName = 'KU_PIXEL.DAT';
      SerialFileName = 'SERIAL.INC';
...
BEGIN
 ...
 IF IOResult <> 0 THEN
  ...
  WHILE (n < 20000) AND (NOT WWWFound)  DO
   BEGIN
    Read(EXEFile,EXEData[0]);
    IF EXEData[0] = 'W' THEN
     BEGIN
...
BEGIN
 ...
 IF ParamCount <> 1 THEN
  BEGIN
   Writeln(' Ingen EXE file defineret >>>     ENTEREXE  <EXE file>');
   Writeln(' Program afbrudt');
   Exit;
  END;
