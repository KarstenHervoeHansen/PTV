...
int main (void) {
   ...
   /* Testing BRAM Memory (plb_bram_if_cntlr_1)*/
   {
      ...
      print("  Running 32-bit test...");
      status = XUtil_MemoryTest32((Xuint32*)XPAR_PLB_BRAM_IF_CNTLR_1_BASEADDR, 512, 0xAAAA5555, XUT_ALLMEMTESTS);
      if (status == XST_SUCCESS) {
         print("PASSED!\r\n");
      }
      else {
      ...
      print("  Running 16-bit test...");
      status = XUtil_MemoryTest16((Xuint16*)XPAR_PLB_BRAM_IF_CNTLR_1_BASEADDR, 1024, 0xAA55, XUT_ALLMEMTESTS);
      if (status == XST_SUCCESS) {
         print("PASSED!\r\n");
      }
      else {
      ...
      print("  Running 8-bit test...");
      status = XUtil_MemoryTest8((Xuint8*)XPAR_PLB_BRAM_IF_CNTLR_1_BASEADDR, 2048, 0xA5, XUT_ALLMEMTESTS);
      if (status == XST_SUCCESS) {
         print("PASSED!\r\n");
      }
      else {
