...
unsigned char code current_FPGA_sw_version=0x13;

//den nuværende MCU software version (bliver vist i PT5300) 10'ere = version, 1'ere = revision
unsigned char code current_MCU_sw_version=93;
...
/************************************************************************************************
*																		                		*
*						GPS Genlock main rutine	NEW HARDWARE			                		*
*																		                		*
...
/****************************************************************************
*																			*
*						GPS Genlock main rutine	OLD HARDWARE				*
*																			*
*		Hovedprogram for GPS					Udgivet 05/02/08			*
*		Udvikler: Jens K Hansen												*
*																			*
...
*																			*
*																			*
*		Special rev 1. 11/01/12: v9.2. Tilpasset 2.5 til at virke i gammel 	*
*								GPS board. Ingen ændringer andet end 		*
*								versions nummer i MCU						*
*																			*
*		Special rev 2. 16/10/12:BS v9.3. Tilpasset 2.9 til at virke i gammel*
*								GPS board. Ingen ændringer andet end 		*
*								versions nummer i MCU for FPGA og MCU		*
*																			*
****************************************************************************/
