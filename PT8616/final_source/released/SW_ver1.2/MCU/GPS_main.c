...
unsigned char code current_MCU_sw_version=12;
...
char tp_select[3] = {pps_i, int_pps_tick_100mhz, NTSC_sync};
...
unsigned char xdata KU_str[11];


int xdata OCXO_phase_diff;
...
//////////////////////////////////////////////////////
		...
		if(ext1_rise_flag==1)
		{
			...
			//ellers hvis låst
			else  //5/5/08: Rev 3: betingleser fjernet, var: else if (OCXO_locked_status)
			{
			...
			if(!timepulse_status)	//5/5/08: Rev 3 var: else if 
				OCXO_counter=0;
			...
			//28/4/08: Rev 2: counter kunne tælle, selvom UTC time valid !=0x07
