...
unsigned int xdata GPS_week=0;
unsigned char xdata GPS_time_valid=0;
char xdata leap_seconds=0;
sbit timepulse_status = P1^0;

//UTC tids info
struct time xdata UTC_time_buffer;
unsigned char xdata UTC_time_valid=0;
...
{0x06, 0x00, 0x14, 0x00, 0x01, 0x00, 0x00, 0x00, 0xD0, 0x08,
 0x08, 0x00, 0x00, 0x96, 0x00, 0x00, 0x07, 0x00, 0x01, 0x00, 
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
 0x00, 0x00, 0x00, 0x00};
...
//indlæsnings buffer
unsigned char xdata msg_buf[32];//var 90
unsigned char ck_a, ck_b;
unsigned char buf_index=0, str_ptr=0;
unsigned int length;
