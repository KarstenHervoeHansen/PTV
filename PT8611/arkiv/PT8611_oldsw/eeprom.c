...
#if 1
sbit SCL =  P1^2; /* PT8640 defs (P1^2)*/
sbit SDA =  P1^1; /* PT8640 defs (P1^1)*/
#else
...
/******************************************************************************/
UC PageWriteE2prom(UC command, UC address, UC idata *buffer, UC count)
  {
  UC i;
...
/******************************************************************************/
UC SeqReadE2prom(UC command, UC  address, UC idata *buffer, UC count)
  {
  UC i;
