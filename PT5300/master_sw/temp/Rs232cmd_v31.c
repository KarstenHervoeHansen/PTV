...
//********                                               ******************
code struct CMD_STRUCT Output[8] =
  {
...
code struct CMD_STRUCT TLGLevel1[3] =
  {
    {FORMATCmdTxt,  FORMCmdTxt, &TLGLevel1[1], NULL, NONE, TLGFormat},
...
code struct PAR_STRUCT TLGFormatPar[21] = 
  {
  {L1Txt,  S1Txt,  &TLGFormatPar[1]},
  {L2Txt,  S2Txt,  &TLGFormatPar[2]},
  {L3Txt,  S3Txt,  &TLGFormatPar[3]},
  {L4Txt,  S4Txt,  &TLGFormatPar[4]},
  {L5Txt,  S5Txt,  &TLGFormatPar[5]},
  {L6Txt,  S6Txt,  &TLGFormatPar[6]},
  {L7Txt,  S7Txt,  &TLGFormatPar[7]},
  {L8Txt,  S8Txt,  &TLGFormatPar[8]},
  {L9Txt,  S9Txt,  &TLGFormatPar[9]},
  {L10Txt, S10Txt, &TLGFormatPar[10]},
  {L11Txt, S11Txt, &TLGFormatPar[11]},
  {L12Txt, S12Txt, &TLGFormatPar[12]},
  {L13Txt, S13Txt, &TLGFormatPar[13]},
  {L14Txt, S14Txt, &TLGFormatPar[14]},
  {L15Txt, S15Txt, &TLGFormatPar[15]},
  {L16Txt, S16Txt, &TLGFormatPar[16]},
  {L17Txt, S17Txt, &TLGFormatPar[17]},
  {L18Txt, S18Txt, &TLGFormatPar[18]},
  {L19Txt, S19Txt, &TLGFormatPar[19]},
  {L20Txt, S20Txt, &TLGFormatPar[20]},
  {L21Txt, S21Txt, NULL}
  };
...
//        Udr_CPutNChar(TLGFormatArrTxt[tmp]);
        Udr_PutChar(',');
#if 1

        TLGSamplesToFLT(TLGConfig[Suffix].Format, TLGConfig[Suffix].Delay, &sign, &field, &line, &time);

        PrintTimingFLT(sign, field, line, time);
#endif
        Udr_PutNewline();
        }
      else
...
//            TrxTLGFormat(Suffix, TLGConfig[Suffix].Format,
//                        TLGConfig[Suffix].Delay + DEF_DELAY(TLGConfig[Suffix].Format));
            }
          }
        }
      }
    ...
    if (CmdExecute && !SCPIError)
      ...
      if (CmdRequest)
        ...
        if (ParState < 3)
          ...
          {
      /*  FindDelayParameters():  Get Field, Line and HTime from RS232 command */
          FindDelayParameters();
          ...
          if (UlongVal != -1)
            ...
            if (UlongVal != TLGConfig[Suffix].Delay)
              ...
              TLGConfig[Suffix].Delay = UlongVal;

//              TrxTLGDelay(Suffix, TLGConfig[Suffix].Delay);
              }
            }
          else
            SCPIError = DataOutOfRange;
...
#if 0
  sprintf(tbuff, "UnitAddress = 0x%x, Receiving.. = %s\r\n", (int)UnitAddress, ascptr);
  Udr_PutNChar(tbuff);
#endif
                }
