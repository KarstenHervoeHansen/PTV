...
/*                                                  */
/*  Changes:                                            */
/* 991103: Error in receiving block data when inserting a white space     */
/*        just before terminating the block data.                  */
/* 991025: Error in receiving octal/binary/hexdecimal numbers when      */
/*        inserting a white space just before terminating the number, eg  */
/*        writing "#H123 ;" is legal.                        */
/* 990305: Corrected error in StateS1 and StateS3. If whitespace() recevied*/
...
void ResponseHandler(char* str)
  ...
  if (!Cstrcmp(str, IDNResponseCmdTxt))
    ...
    {
    if (!Cstrncmp(str, DownloadResponseCmdTxt, Cstrlen(DownloadResponseCmdTxt)))
      {
      State  = StateP6;
