...
code char ETHConfigTxt[]   = "ETHERNET";
...
code char iPAL[]   = "Internal PAL";
code char iNTSC[]   = "Internal NTSC";

code char VITCAInputTxt[]             = "VITC on A";
...
code char ETHConnTxt[]           = "[  ETH]: ";
code char LTCConnTxt[]           = "[  LTC]: ";
...
code char DHCPTxt[]				= "DHCP";
code char IPAddrTxt[]			= "IP ADDR";
code char SUBNETTxt[]			= "SUBNET MASK";
code char GATEWAYTxt[]			= "GATEWAY";
code char DNSTxt[]				= "DNS SERVER";
code char MACTxt[]				= "MAC ADDR";
code char NetfinderTxt[]		= "NETFINDER";
code char TelnetTxt[]			= "TELNET";
code char ResetPasswordTxt[]	= "RESET PASSWORD";
code char PortTxt[]				= "PORT";
...
code char* TRIArrTxt[] =  /* JK addition */
  ...
  code char GPSInputTxt[]				 = "GPS-input";
  code char AutoInputTxt[]			 = "Auto";
  //code char VideoFieldFreqInputTxt[]	 = "Video Field Freq";
  


  code char* TimeRefArrTxt[]	= { VITCAInputTxt,
