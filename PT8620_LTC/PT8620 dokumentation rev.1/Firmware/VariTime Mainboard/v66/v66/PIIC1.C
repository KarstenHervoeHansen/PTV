...
UC IIC1RdChar( UC Address, UC subadr) {
...
/*  Updates:    IIC1ErrorCode                               */
/***************************************************************************/
bit IIC1WrStrN( UC Address, UC subadr, char* s,UC N) {
...
/***************************************************************************/
/*  IIC1WriteLong                                       PIIC1.C */
/*                                                  */
/* Author:    Mikkel Melin, IPU, 31.08.13                       */
/* Revised:                                      */
/*                                                  */
/*  Function: Write Long  bytes to an IIC address                 */
/*  Remarks:    --                                        */
/*  Returns:    Acknowledge bit, 1:OK, 0:ERROR                    */
/*  Updates:    IIC1ErrorCode                               */
/***************************************************************************/
bit IIC1WriteLong( UC Address, UL Data) {
  ...
  for ( i=0; i < Retry; i++)
    if ( Acknowledge = ByteTx1( Address)) {
      ...
      for ( i = 0; i < 25; i=i+8)
        if ( !( Acknowledge = ByteTx1( (Data >> i)& 0xFF )))
          break;
